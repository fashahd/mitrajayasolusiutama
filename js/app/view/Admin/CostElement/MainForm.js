...
Ext.define('MitraJaya.view.Admin.CostElement.MainForm', {
    extend: 'Ext.panel.Panel',
    id: 'MitraJaya.view.Admin.CostElement.MainForm',
        ...
        afterRender: function () {
            ...
            if (thisObj.viewVar.OpsiDisplay == 'view' || thisObj.viewVar.OpsiDisplay == 'update') {
                ...
                if (thisObj.viewVar.OpsiDisplay == 'view') {
                    Ext.getCmp('MitraJaya.view.Admin.CostElement.MainForm-FormBasicData-BtnSave').setVisible(false);
                }

                //load formnya
                Ext.getCmp('MitraJaya.view.Admin.CostElement.MainForm-FormBasicData').getForm().load({
                    url: m_api + '/v1/admin/Component/form_component',
                    method: 'GET',
                    params: {
                        ComponentID: this.viewVar.ComponentID
                    },
        ...
        thisObj.ObjPanelBasicData = Ext.create('Ext.panel.Panel', {
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        xtype: 'form',
                        id: 'MitraJaya.view.Admin.CostElement.MainForm-FormBasicData',
                        fileUpload: true,
                        buttonAlign: 'center',
                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                items: [{
                                    xtype: 'textfield',
                                    inputType: 'hidden',
                                    id: 'MitraJaya.view.Admin.CostElement.MainForm-FormBasicData-ComponentID',
                                    name: 'MitraJaya.view.Admin.CostElement.MainForm-FormBasicData-ComponentID'
                                }, {
                                    xtype: 'textfield',
                                    labelAlign:'top',
                                    allowBlank: false,
                        ...
                        buttons: [{
                            ...
                            handler: function () {
                                var Formnya = Ext.getCmp('MitraJaya.view.Admin.CostElement.MainForm-FormBasicData').getForm();

                                if (Formnya.isValid()) {
                                    Formnya.submit({
                                        url: m_api + '/v1/admin/component/submit',
                                        method: 'POST',
                                        waitMsg: 'Saving data CostElement...',
                                        params: {
                                        ...
                                        success: function (fp, o) {
											Swal.fire({
												...
												if (result.isConfirmed) {
													Ext.getCmp('MitraJaya.view.Admin.CostElement.MainForm').destroy(); //destory current view
													var MainForm = [];
													if (Ext.getCmp('MitraJaya.view.Admin.CostElement.MainForm') == undefined) {
														MainForm = Ext.create('MitraJaya.view.Admin.CostElement.MainForm', {
															viewVar: {
																OpsiDisplay: 'update',
																ComponentID: o.result.ComponentID
															}
														});
													} else {
    ...
    BackToList: function () {
        ...
        if (Ext.getCmp('MitraJaya.view.Admin.CostElement.MainGrid') == undefined) {
            GridMainGrower = Ext.create('MitraJaya.view.Admin.CostElement.MainGrid');
        } else {
