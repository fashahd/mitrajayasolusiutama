    ...
    initComponent: function() {
        ...
        thisObj.items = [{
            ...
            columns:[{
                ...
                text: lang('User Login'),
                dataIndex: 'exist_user',
                flex: 10,
                renderer: function (t, meta, record) {
                    let RetVal;
					if(record.data.exist_user == "Yes"){
						RetVal = `<span class="external-event bg-success ui-draggable ui-draggable-handle">`+record.data.exist_user+`</span>`;
					}else{
						RetVal = `<span class="external-event bg-danger ui-draggable ui-draggable-handle">`+record.data.exist_user+`</span>`;
					}
                    return RetVal;
                }
            }]
