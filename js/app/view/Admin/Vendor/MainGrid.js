 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.view.Admin.Vendor.MainGrid' ,{
    extend: 'Ext.panel.Panel',
    id: 'MitraJaya.view.Admin.Vendor.MainGrid',
    ...
    listeners: {
        afterRender: function(component, eOpts){
            ...
            if(customer_src){
                Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-keySearch').setValue(customer_src.keySearch);
            }
        }
    },
    initComponent: function() {
		...
		// console.log(m_api);
        //Store
        thisObj.StoreGridMain = Ext.create('MitraJaya.store.Admin.Vendor.MainGrid');
        ...
        thisObj.ContextMenuGrid = Ext.create('Ext.menu.Menu',{
	        ...
	        items:[{
	            ...
	            handler: function() {
                    var sm = Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-Grid').getSelectionModel().getSelection()[0];
                    Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid').destroy(); //destory current view
                    
                    var FormMainFarmer = [];
                    if(Ext.getCmp('MitraJaya.view.Admin.Vendor.MainForm') == undefined){
                        FormMainFarmer = Ext.create('MitraJaya.view.Admin.Vendor.MainForm', {
                            viewVar: {
                                OpsiDisplay: 'view',
                                VendorID: sm.get('VendorID'),
	            ...
	            handler: function(){
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							Ext.Ajax.request({
								waitMsg: 'Please Wait',
								url: m_api + '/v1/admin/vendor/delete_vendor',
								method: 'DELETE',
								params: {
									VendorID: sm.get('VendorID')
								},
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'MitraJaya.view.Admin.Vendor.MainGrid-Grid',
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    id: 'MitraJaya.view.Admin.Vendor.MainGrid-BtnAdd',
                    handler: function() {
                        Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid').destroy(); //destory current view
                    	var FormMainFarmer = [];
                    ...
                    id: 'MitraJaya.view.Admin.Vendor.MainGrid-BtnExport',
                    handler: function() {
						var keySearch	= Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-keySearch').getValue();
						var StartDate	= Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-StartDate').getValue();
						var EndDate		= Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-EndDate').getValue();
						var VendorID	= Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-VendorID').getValue();
                    ...
                    overCls:'Sfr_BtnGridNewWhite-Hover',
                    hidden: m_act_export_excel,
                    id: 'MitraJaya.view.Admin.Vendor.MainGrid-BtnImport',
                    handler: function() {
					...
					name: 'MitraJaya.view.Admin.Vendor.MainGrid-keySearch',
					id: 'MitraJaya.view.Admin.Vendor.MainGrid-keySearch',
					xtype: 'textfield',
                    ...
                    id: 'MitraJaya.view.Admin.Vendor.MainGrid-BtnReload',
                    handler: function() {
                        Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-Grid').getStore().loadPage(1);
                    }
                }]
            }],
            columns:[{
    ...
    submitOnEnterGrid: function (field, event) {   
		localStorage.setItem('customer_src', JSON.stringify({
			keySearch	: Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-keySearch').getValue()
		}));
		Ext.getCmp('MitraJaya.view.Admin.Vendor.MainGrid-Grid').getStore().loadPage(1);
    }
});
