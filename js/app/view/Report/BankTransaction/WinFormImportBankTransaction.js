Ext.define('MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction', {
    ...
    initComponent: function () {
        ...
        var storeGridFailed = Ext.create('MitraJaya.store.Report.BankTransaction.MainGridImportFailed');
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        handler: function () {
                            ...
                            Ext.Ajax.request({
                                url: m_api + '/v1/report/bank_transaction/generate_template',
                                method: 'POST',
                    ...
                    items: [{
                        xtype: 'form',
                        id: 'MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-Form',
                        fileUpload: true,
                        items: [{
                            layout: 'column',
                            items: [{
                                ...
                                name: 'bank_transaction_ImportFile',
                                id: 'MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-Form-ImportFile',
                                fieldLabel: 'Upload File',
                                alowBlank: false,
                                baseCls: 'Sfr_FormInputMandatory',
                                listeners: {
                                    'change': function (fb, v) {
                                        var form = Ext.getCmp('MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-Form').getForm();
                                        if (form.isValid()) {
                                            form.submit({
                                                url: m_api + '/v1/report/bank_transaction/import',
                                                method: 'POST',
                                ...
                                xtype: 'hiddenfield',
                                id: 'MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-Form-FileName',
                                name: 'MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-Form-FileName',
                            }, {
                                columnWidth: 0.5,
                                items: [{
                                    xtype: 'button',
                    ...
                    xtype: 'grid',
                    id: 'MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction-FailedData',
    ...
    buttons: [{
        ...
        cls: 's-grey',
        handler: function () {
            Ext.getCmp('MitraJaya.view.Report.BankTransaction.WinFormImportBankTransaction').close();
        }
    }],
    listeners: {
