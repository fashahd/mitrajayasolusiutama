						...
						items: [{
							...
							items: [{
								...
								items: [{
									...
									xtype: 'textfield',
									id:'MitraJaya.view.Finance.OrderBook.MainForm-FormBasicData-Project',
									name:'MitraJaya.view.Finance.OrderBook.MainForm-FormBasicData-Project',
									labelAlign:'top',
									fieldLabel:'Project'						
								},{
									xtype: 'combobox',
								...
								items: [{
									xtype: 'numericfield',
									id:'MitraJaya.view.Finance.OrderBook.MainForm-FormBasicData-Qty',
									name:'MitraJaya.view.Finance.OrderBook.MainForm-FormBasicData-Qty',
									labelAlign:'top',
									fieldLabel:'Qty'								
								}, {
									xtype: 'numericfield',
