...
Ext.define('MitraJaya.view.Finance.Pajak.WinPajak' ,{
    ...
    initComponent: function() {
        ...
        thisObj.items = Ext.create('Ext.panel.Panel', {
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        xtype: 'form',
                        id: 'MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData',
                        fileUpload: true,
                        buttonAlign: 'center',
                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                items: [{
                                    xtype: 'textfield',
                                    inputType: 'hidden',
                                    id: 'MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Month',
                                    name: 'MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Month'
                                }, {
                                    xtype: 'textfield',
                                    inputType: 'hidden',
                                    id: 'MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Year',
                                    name: 'MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Year'
                                }, {
                                    xtype: 'textfield',
                                    labelAlign:'top',
        ...
        thisObj.buttons = [{
			...
			handler: function () {
				var Formnya = Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData').getForm();

				if (Formnya.isValid()) {

					Formnya.submit({
						url: m_api + '/v1/finance/pajak/submit_pajak',
						method: 'POST',
						waitMsg: 'Saving data...',
						params: {
    ...
    listeners: {
        afterRender: function(){
			...
			Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Month').setValue(thisObj.viewVar.Month);
			Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Year').setValue(thisObj.viewVar.Year);
			Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Period').setValue(thisObj.viewVar.Period);
			Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-Amount').setValue(thisObj.viewVar.Amount);
			Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-VATAmount').setValue(thisObj.viewVar.VATAmount);

            // Conditionanl Add Newa or view/update
			console.log(thisObj.viewVar.OpsiDisplay);
                if(thisObj.viewVar.OpsiDisplay == 'view') {
					Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-BtnSave').setVisible(false);
                }

				//load data form
				Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData').getForm().load({
    ...
    AddValidationBasicForm: function(){
        ...
        //Cek Umur ================================================== (Begin)
        if(Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-FamRelation').getValue() == '1'){
            var YearBirth = parseInt(Ext.getCmp('MitraJaya.view.Finance.Pajak.WinPajak-FormBasicData-BirthYear').getValue());
            var today = new Date();
