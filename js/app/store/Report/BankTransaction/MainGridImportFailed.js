 ...
 *******************************************/
 Ext.define('MitraJaya.store.Report.BankTransaction.MainGridImportFailed', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Report.BankTransaction.MainGridImportFailed',
    storeId: 'MitraJaya.store.Report.BankTransaction.MainGridImportFailed',
    fields: [
		'BankTransactionID',
		'DateTransaction',
		'CheckingAccount',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/report/bank_transaction/list_import_failed',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
    ...
    loadInfoFilter: function() {
        Ext.Ajax.request({
            ...
            success: function(data) {
                ...
                //         document.getElementById('Sfr_IdBoxInfoFilterGrid').innerHTML = '<strong>'+'Data filter by'+':</strong>&nbsp;&nbsp;<span style="color:#895608;">'+bank_transaction_storage.join(', ')+'</span>';
                //     else
