 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.PinjamanSubCont.GridLoanPayment', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.PinjamanSubCont.GridLoanPayment',
    storeId: 'MitraJaya.store.Finance.PinjamanSubCont.GridLoanPayment',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/loan/payment_loan_list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
