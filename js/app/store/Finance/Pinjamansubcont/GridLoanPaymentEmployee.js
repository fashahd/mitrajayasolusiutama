 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.PinjamanSubCont.GridLoanPaymentEmployee', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.PinjamanSubCont.GridLoanPaymentEmployee',
    storeId: 'MitraJaya.store.Finance.PinjamanSubCont.GridLoanPaymentEmployee',
    fields: ['DocumentNo','LoanPaymentID','LoanID','LoanPaymentAmount','LoanPaymentDate','PaymentLoanDescription'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/loan/payment_loan_list_employee',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
