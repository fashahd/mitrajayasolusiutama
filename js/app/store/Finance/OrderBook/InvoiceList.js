 ...
 *  File : InvoiceList.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.OrderBook.InvoiceList', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.OrderBook.InvoiceList',
    storeId: 'MitraJaya.store.Finance.OrderBook.InvoiceList',
    fields: ['InvoiceID','InvoiceNumber','DueDate','Amount','Status'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/order/list_invoice',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
    ...
    listeners: {
        ...
        beforeload: function(store, operation, options){			
            store.proxy.extraParams.OrderBookID = this.storeVar.OrderBookID;
        }
    },
