 ...
 *******************************************/
 Ext.define('MitraJaya.store.Finance.OrderBook.MainGridImportFailed', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.OrderBook.MainGridImportFailed',
    storeId: 'MitraJaya.store.Finance.OrderBook.MainGridImportFailed',
    fields: ['OrderBookID','ContractNumber','ProjectName','CustomerName','TotalContactAmount','ContractDate','TotalPaid','TotalUnpaid','Description','DeptName','ErrorMessages'],
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/order/list_import_failed',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
