 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.OrderBook.MainGrid', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.OrderBook.MainGrid',
    storeId: 'MitraJaya.store.Finance.OrderBook.MainGrid',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/order/list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
