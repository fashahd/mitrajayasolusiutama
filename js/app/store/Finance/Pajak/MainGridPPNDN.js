 ...
 *  File : MainGridPPNDN.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.Pajak.MainGridPPNDN', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.Pajak.MainGridPPNDN',
    storeId: 'MitraJaya.store.Finance.Pajak.MainGridPPNDN',
    fields: ['PajakID','Period','Month','Year','Amount','VATAmount'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/pajak/list_ppndn',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
