 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Finance.Loan.GridLoanPayment', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Finance.Loan.GridLoanPayment',
    storeId: 'MitraJaya.store.Finance.Loan.GridLoanPayment',
    fields: ['DocumentNo','EmployeeLoanPaymentID','EmployeeLoanID','LoanPaymentAmount','LoanPaymentDate'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/finance/employeeloan/payment_loan_list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
    ...
    listeners: {
        ...
        beforeload: function(store, operation, options){
            store.proxy.extraParams.EmployeeLoanID = this.storeVar.EmployeeLoanID;
        }
    },
