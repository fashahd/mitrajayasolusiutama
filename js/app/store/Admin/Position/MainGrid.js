 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Admin.Position.MainGrid', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Admin.Position.MainGrid',
    storeId: 'MitraJaya.store.Admin.Position.MainGrid',
    fields: ['position_id', 'position_code', 'position_name'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/admin/position/list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
