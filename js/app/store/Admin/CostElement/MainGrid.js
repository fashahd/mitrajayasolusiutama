 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Admin.CostElement.MainGrid', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Admin.CostElement.MainGrid',
    storeId: 'MitraJaya.store.Admin.CostElement.MainGrid',
    fields: ['ComponentID', 'Code', 'Description'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/admin/component/list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
