 ...
 *  File : GridCertification.js
 *******************************************/
 Ext.define('MitraJaya.store.Admin.Employee.GridCertification', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Admin.Employee.GridCertification',
    storeId: 'MitraJaya.store.Admin.Employee.GridCertification',
    fields: ['cert_id','people_id','cert_name','start_date','end_date','cert_code'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/admin/employee/certification_list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
