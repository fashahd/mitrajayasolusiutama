 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.Admin.Vendor.MainGrid', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.Admin.Vendor.MainGrid',
    storeId: 'MitraJaya.store.Admin.Vendor.MainGrid',
    fields: ['VendorID', 'VendorDisplayID', 'VendorName', 'VendorPhone', 'VendorEmail','VendorAddress','VendorType'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/admin/vendor/list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
