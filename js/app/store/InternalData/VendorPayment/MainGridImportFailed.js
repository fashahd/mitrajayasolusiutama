 ...
 *******************************************/
 Ext.define('MitraJaya.store.InternalData.VendorPayment.MainGridImportFailed', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.InternalData.VendorPayment.MainGridImportFailed',
    storeId: 'MitraJaya.store.InternalData.VendorPayment.MainGridImportFailed',
    fields: [
		'PaymentID',
		'DocumentNo',
		'ProjectID',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/internaldata/vendorpayment/list_import_failed',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
