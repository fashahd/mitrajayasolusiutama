 ...
 *  File : MainGrid.js
 *******************************************/
 Ext.define('MitraJaya.store.InternalData.VendorPayment.GridVendorPayment', {
    extend: 'Ext.data.Store',
    id: 'MitraJaya.store.InternalData.VendorPayment.GridVendorPayment',
    storeId: 'MitraJaya.store.InternalData.VendorPayment.GridVendorPayment',
    fields: ['DocumentNo','VendorPaymentID','PaymentID','VendorPaymentAmount','VendorPaymentDate'],
    pageSize: 50,
    autoLoad: true,
    storeVar: false,
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/v1/internaldata/vendorpayment/payment_vendor_list',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
    ...
    listeners: {
        ...
        beforeload: function(store, operation, options){
            store.proxy.extraParams.PaymentID = this.storeVar.PaymentID;
        }
    },
